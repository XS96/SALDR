...
# Bulid the autoencoder model of CsiNet-v3
def residual_network(x):
    ...
    # decoder Net
    x = Reshape((img_channels, img_height, img_width,))(x)  # reshape to real channel and im channel
    x = DenseRefine(x)
...
outfile = './CsiNetv3_result/ck_CsiNetv3_indoor25604-22_17-10.hdf5'
...
print("CsiNET-v3: NMSE is ", 10 * math.log10(np.mean(mse / power)))
print("CsiNet-v3: Correlation is ", np.mean(rho))
